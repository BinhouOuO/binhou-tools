...
|---|---|---|
| `com.binhou.batchrenamer` | Batch Renamer Tool for Unity objects & assets | `batchrenamer/` |
...
```
https://github.com/Binhou/unity-tools.git?path=/Packages/com.binhou.batchrenamer#batchrenamer/v1.0.0
```

- `?path=` specifies the exact package directory to import.
- `#batchrenamer/v1.0.0` is the scoped tag ensuring independent version control for each package in this repository.
...
- Batch Renamer: `batchrenamer/v1.0.0`, `batchrenamer/v1.1.0` ...
